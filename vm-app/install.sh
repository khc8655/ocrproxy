...
ExecStart=${INSTALL_DIR}/venv/bin/uvicorn app.main:app --host :: --port ${APP_PORT} --workers 1 --limit-concurrency 150 --timeout-keep-alive 30 --timeout-graceful-shutdown 10 --no-server-header
Restart=always
RestartSec=5
